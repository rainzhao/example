...
public class DubboServiceModel {
    ...
    public static void main(String[] args) {
        ...
        String str = "dubbo://172.16.248.20:20690/com.tuya.edgegateway.client.IDeviceService?anyhost=true&application=edge-gateway-proxy&bean.name=com.tuya.edgegateway.client.IDeviceService&deprecated=false&disabled=true&dubbo=2.0.2&dynamic=true&generic=false&interface=com.tuya.edgegateway.client.IDeviceService&methods=syncDeviceWithAutoActive,issueDeviceCommand,deviceActive,queryDevice,queryDeviceList&pid=1&release=2.7.4-TUYA-SNAPSHOT&service.filter=-exception&side=provider&timeout=20000&timestamp=1577238413941";
        DubboServiceModel d = new DubboServiceModel(str);
